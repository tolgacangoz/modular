...
class ImageGenerationRequest(Request):
    ...
    image_prompt_transcription: str = ""
    """The image prompt transcription to use for image generation."""
    ...
    This replaces automatically generating TokenGeneratorRequestMessages given the input, image prompt tokens,
    image prompt transcription fields."""
