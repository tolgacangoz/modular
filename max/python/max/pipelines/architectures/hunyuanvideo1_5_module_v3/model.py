...
from max.pipelines.architectures.qwen2_5.qwen2_5 import Qwen2_5VL
...
from .model_config import HunyuanVideo15Config
...
from .hunyuan_video15 import HunyuanVideo15

logger = logging.getLogger("max.pipelines")


@dataclass(eq=False)
class HunyuanVideo15Inputs(ModelInputs):
    """A class representing inputs for the HunyuanVideo15 model.

    This class encapsulates the input tensors required for the HunyuanVideo15 model execution,
...
class HunyuanVideo15Model(
    # AlwaysSignalBuffersMixin,
    PipelineModel[TextContext],
):
    """A HunyuanVideo15 model for text-to-image generation."""
    ...
    model_config: HunyuanVideo15Config | None
    """The HunyuanVideo15 model configuration."""
    ...
    def __init__(
        ...
        # For HunyuanVideo15, the Hugging Face repository is a diffusers pipeline with
        ...
        # scheduler, VAE, and transformer components so HunyuanVideo15Config.generate
    ...
    def _build_text_encoder_graph(
        ...
        """
        with Graph("qwen2_5vl_text_encoder", input_types=graph_inputs) as graph:
