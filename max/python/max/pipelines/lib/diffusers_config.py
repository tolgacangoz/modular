...
class DiffusersConfig:
    ...
    pipeline_class: str
    """The diffusers pipeline class name (e.g., 'StableDiffusion3Pipeline')."""
    ...
    def get_component(self, name: str) -> DiffusersComponentConfig | None:
        ...
        Returns:
            The component config, or None if not found.
        """
    ...
    def component_names(self) -> list[str]:
        """List of all component names in this pipeline."""
    ...
    def has_vae(self) -> bool:
        """Whether this pipeline has a VAE component."""
        return "vae" in self.components

    @property
    def has_transformer(self) -> bool:
        """Whether this pipeline has a transformer component."""
        return "transformer" in self.components

    @property
    def has_unet(self) -> bool:
        """Whether this pipeline has a UNet component."""
        return "unet" in self.components
